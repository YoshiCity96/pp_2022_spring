...
#ifndef MODULES_TASK_2_RUDOY_V_SORT_DOUB_SIMP_OMP_DISCHARGE_DOUBLE_SORT_OMP_H_
#define MODULES_TASK_2_RUDOY_V_SORT_DOUB_SIMP_OMP_DISCHARGE_DOUBLE_SORT_OMP_H_
#include <vector>
#include <list>
struct vector {
    double* ptr;
...
#endif  // MODULES_TASK_2_RUDOY_V_SORT_DOUB_SIMP_OMP_DISCHARGE_DOUBLE_SORT_OMP_H_
