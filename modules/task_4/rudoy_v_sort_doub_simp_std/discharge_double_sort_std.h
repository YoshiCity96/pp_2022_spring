...
#ifndef MODULES_TASK_4_RUDOY_V_SORT_DOUB_SIMP_STD_DISCHARGE_DOUBLE_SORT_STD_H_
#define MODULES_TASK_4_RUDOY_V_SORT_DOUB_SIMP_STD_DISCHARGE_DOUBLE_SORT_STD_H_
#include <vector>
#include <list>
struct vector {
    double* ptr;
...
#endif  // MODULES_TASK_4_RUDOY_V_SORT_DOUB_SIMP_STD_DISCHARGE_DOUBLE_SORT_STD_H_
