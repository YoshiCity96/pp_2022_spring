...
#ifndef MODULES_TASK_3_RUDOY_V_SORT_DOUB_SIMP_TBB_DISCHARGE_DOUBLE_SORT_TBB_H_
#define MODULES_TASK_3_RUDOY_V_SORT_DOUB_SIMP_TBB_DISCHARGE_DOUBLE_SORT_TBB_H_
...
#endif  // MODULES_TASK_3_RUDOY_V_SORT_DOUB_SIMP_TBB_DISCHARGE_DOUBLE_SORT_TBB_H_
