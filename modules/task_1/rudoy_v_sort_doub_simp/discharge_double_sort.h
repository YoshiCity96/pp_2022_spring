...
#ifndef MODULES_TASK_1_RUDOY_V_SORT_DOUB_SIMP_DISCHARGE_DOUBLE_SORT_H_
#define MODULES_TASK_1_RUDOY_V_SORT_DOUB_SIMP_DISCHARGE_DOUBLE_SORT_H_
#include <vector>
#include <list>
...
#endif  // MODULES_TASK_1_RUDOY_V_SORT_DOUB_SIMP_DISCHARGE_DOUBLE_SORT_H_
